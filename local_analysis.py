...
save_analysis_path = os.path.join(load_model_dir,load_model_name+"_test",test_image_name)
...
empty_mask = torch.zeros(1,7,7,dtype=torch.float)

logits, min_distances, masked_output, min_masked_distances,activation,masked_activation = ppnet_multi(images_test,empty_mask)
